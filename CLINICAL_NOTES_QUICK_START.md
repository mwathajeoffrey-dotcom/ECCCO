# 📝 Clinical Notes - Quick Start Guide

## 🎯 What Is This?

**Clinical Notes** is your personal evidence-based learning journal built directly into ECCCO. It's like having a smart notebook that remembers what you searched, what you learned, and helps you track how your understanding evolves over time.
...
- ✅ **Update** notes when guidelines change (version tracking!)
- ✅ **Separate** from quiz notes (clean organization)
...
3. Wait for AI synthesis to load
```
...
6. Write your notes (use the helpful template)
7. Add tags: sepsis, emergency, ICU
8. Click "Save Note"
```
...
│ • Write questions for exploration      │
│ • Note contradictions with practice    │
│ • Track understanding evolution        │
│                                         │
│ Note Title: [Auto-filled]              │
│ Your Notes: [Big text area]            │
│ Tags: [sepsis] [emergency] [ICU]       │
...
[Search notes...] [Filter by tag ▼]

Stats:
┌─────────────┐ ┌─────────────┐ ┌─────────────┐
│ 📄 15       │ │ 🏷️ 12       │ │ 🕐 Today    │
│ Total Notes │ │ Unique Tags │ │ Last Update │
└─────────────┘ └─────────────┘ └─────────────┘
...
│ 🏷️ sepsis, emergency, ICU              │
│ 📅 Jan 21, 2026 • Emergency Medicine   │
│ [Edit] [Delete] [▼]                    │
├─────────────────────────────────────────┤
...
4. Save → Version increments (v1 → v2)
5. "(Updated)" badge appears
6. Track evolution of your understanding!
```
...
In any note:
1. Expand the note
2. Click "Re-search this topic"
3. Instantly redirected to Evidence Search
4. Original query pre-filled and executed
5. See latest evidence!
```
...
- What you searched
- When you searched
- The AI synthesis you read
- Sources you reviewed

One-click back to the evidence!
```
...
### Example 1: Medical Student Studying for Shelf Exam
...
🏷️ Tags: DKA, endocrine, emergency, high-yield
```

**Benefit:** Perfect personalized study guide for shelf exam!

### Example 2: Resident Managing ICU Case
...
🏥 Patient: 72yo, septic shock from pneumonia, COPD baseline
🏷️ Tags: sepsis, vasopressors, ICU, real-case
```

**Benefit:** Document real clinical reasoning, discuss in rounds!
...
- Monoclonal antibodies no longer effective vs new variants

Version 1 | Saved March 2025
```
...
- REMOVED: Several monoclonals discontinued

Version 2 | Updated Oct 2025
```

**Benefit:** Track how evidence evolves, stay current!
...
```
┌─────────────────────────────────────────┐
│         CLINICAL NOTES CHEAT SHEET      │
├─────────────────────────────────────────┤
│ CREATE NOTE:                            │
│ Evidence Search → Take Notes button    │
│                                         │
│ VIEW NOTES:                             │
│ Sidebar → Clinical Notes                │
│                                         │
│ EDIT NOTE:                              │
│ Open note → Click Edit icon (pencil)   │
│                                         │
│ DELETE NOTE:                            │
│ Open note → Click Delete icon (trash)  │
...
│                                         │
│ FILTER BY TAG:                          │
│ Use tag dropdown → Select tag           │
│                                         │
│ RE-SEARCH TOPIC:                        │
│ Expand note → Re-search this topic btn │
│                                         │
│ KEYBOARD SHORTCUTS:                     │
...
1. **Open ECCCO**
2. **Click "Evidence Search"** in sidebar
3. **Search something interesting**
4. **Click "📝 Take Clinical Notes"**
5. **Start building your learning journal!**
