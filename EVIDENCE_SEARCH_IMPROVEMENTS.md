...
const searchTemplates = [
  ...
  { label: "Clinical Question", placeholder: "e.g., management of diabetic ketoacidosis" },
...
export async function POST(request: NextRequest) {
  ...
  const drugKeywords = ['dosing', 'dose', 'indication', 'contraindication', 
                        'interaction', 'adverse effect', 'monitoring'];
