      ...
      // Pages and other routes - Security headers only, let Next.js handle caching
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://*.clerk.accounts.dev https://*.accounts.dev https://*.clerk.com https://vercel.live https://www.google.com https://www.gstatic.com https://www.recaptcha.net",
              "worker-src 'self' blob:",
              "style-src 'self' 'unsafe-inline' https://www.gstatic.com",
              "img-src 'self' data: https: blob:",
              "font-src 'self' data:",
              "connect-src 'self' https://*.clerk.accounts.dev https://*.accounts.dev https://*.clerk.com https://vercel.live wss://ws.pusherapp.com https://*.vercel.app https://*.vercel-analytics.com https://www.google.com https://www.recaptcha.net",
