...
export default function EnhancedExamInterface() {
  ...
  const averageTimePerQuestion =
    answeredCount > 0 ? Object.values(questionTimes).reduce((sum, time) => sum + time, 0) / answeredCount : 0;
      ...
      <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-6 sm:mb-8">
            ...
            {user && <p className="text-blue-600 text-sm mt-2">Your progress will be saved to your dashboard</p>}
          </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-6">
              {!isStudyMode && (
                <div className="flex items-center space-x-1 sm:space-x-2">
                  <span
                    className={`font-mono text-sm sm:text-lg ${timeRemaining < 300 ? "text-red-600" : "text-gray-900"}`}
                  >
