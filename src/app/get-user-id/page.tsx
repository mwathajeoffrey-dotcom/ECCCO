      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 mb-6">
          ...
          <p className="text-sm text-blue-800">
            Use this ID to grant yourself admin and developer permissions
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-2">Add to your <code className="bg-gray-100 px-2 py-1 rounded">.env.local</code> file:</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <ol className="list-decimal list-inside space-y-1 text-sm text-gray-600 ml-4">
                  ...
                  <li>Add <code className="bg-gray-100 px-1 rounded">ADMIN_USER_IDS</code> with value: <code className="bg-gray-100 px-1 rounded">{userId || 'your_user_id'}</code></li>
                  <li>Add <code className="bg-gray-100 px-1 rounded">DEVELOPER_USER_IDS</code> with value: <code className="bg-gray-100 px-1 rounded">{userId || 'your_user_id'}</code></li>
                  <li>Click "Save"</li>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <ul className="space-y-1 text-sm text-gray-600">
                  <li>• <Link href="/admin/dashboard" className="text-blue-600 hover:underline">/admin/dashboard</Link> - Admin panel</li>
                  <li>• <Link href="/admin/users" className="text-blue-600 hover:underline">/admin/users</Link> - User management</li>
                  <li>• <Link href="/guidelines" className="text-blue-600 hover:underline">/guidelines</Link> - Guidelines editor (developer access)</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-800">
                Never commit your <code className="bg-yellow-100 px-1 rounded">.env.local</code> file to git. 
                It's already in <code className="bg-yellow-100 px-1 rounded">.gitignore</code> to prevent this.
              </p>
            </div>
          </div>
        </div>
