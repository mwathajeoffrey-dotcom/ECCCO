...
import { 
  ...
  BookMarked, Sparkles, Target, MessageSquare, Calendar
} from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Emergency & Critical Care Comprehensive Online</p>
              </div>
            </Link>
            <nav className="hidden md:flex space-x-6">
              ...
              <Link href="/practice" className="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                Practice
              </Link>
              <Link href="/emergency-references" className="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                Evidence Library
              </Link>
              <Link href="/live-quiz" className="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                Live Quiz
              </Link>
              <Link href="/learning-analytics" className="text-gray-700 hover:text-blue-600 font-medium transition-colors">
                Analytics
              </Link>
              <Link href="/support" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
                Support
              </Link>
            </nav>
          </div>
