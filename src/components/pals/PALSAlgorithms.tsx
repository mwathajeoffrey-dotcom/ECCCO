      ...
      <div className="max-w-6xl mx-auto p-6">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600">
            Evidence-based step-by-step protocols for pediatric emergencies
          </p>
        </div>
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-xl p-6">
          ...
          <p className="text-sm text-blue-800">
            All algorithms are based on the American Heart Association PALS Guidelines 2020 and are
            updated regularly to reflect current evidence-based practices.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Step {currentStepIndex + 1} of {selectedAlgorithm.steps.length}</p>
          </div>
      ...
      <div className="flex justify-between">
        ...
        <button
          onClick={() =>
            setCurrentStepIndex(Math.min(selectedAlgorithm.steps.length - 1, currentStepIndex + 1))
          }
