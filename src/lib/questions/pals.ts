...
export const palsQuestions: Question[] = [
  {
    id: 'pals-001',
    question: 'What is the compression-to-ventilation ratio for infant CPR with one rescuer according to 2025 AHA PALS guidelines?',
    options: [
      '15:2',
      '30:2',
      '5:1',
    ...
    references: [
      'Topjian AA, et al. Part 4: Pediatric Basic and Advanced Life Support: 2025 American Heart Association Guidelines',
  ...
  },
  {
    ...
    references: [
      'Aziz K, et al. Part 5: Neonatal Resuscitation: 2025 American Heart Association Guidelines',
